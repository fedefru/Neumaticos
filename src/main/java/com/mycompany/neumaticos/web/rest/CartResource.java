...
import com.mycompany.neumaticos.domain.Cart;
import com.mycompany.neumaticos.repository.CartRepository;
...
/**
 * REST controller for managing {@link com.mycompany.neumaticos.domain.Cart}.
 */
@RestController
@RequestMapping("/api")
@Transactional
