...
import com.mycompany.neumaticos.repository.StockRepository;
...
public class StockResourceIT {
    ...
    private static final Long DEFAULT_MINIMUMSTOCK = 1L;
    private static final Long UPDATED_MINIMUMSTOCK = 2L;

    private static final Long DEFAULT_MAXIMUMSTOCK = 1L;
    private static final Long UPDATED_MAXIMUMSTOCK = 2L;
    ...
    public static Stock createEntity(EntityManager em) {
        Stock stock = new Stock()
            .stock(DEFAULT_STOCK)
            .minimumstock(DEFAULT_MINIMUMSTOCK)
            .maximumstock(DEFAULT_MAXIMUMSTOCK)
    ...
    public static Stock createUpdatedEntity(EntityManager em) {
        Stock stock = new Stock()
            .stock(UPDATED_STOCK)
            .minimumstock(UPDATED_MINIMUMSTOCK)
            .maximumstock(UPDATED_MAXIMUMSTOCK)
    ...
    public void createStock() throws Exception {
        ...
        assertThat(testStock.getMinimumstock()).isEqualTo(DEFAULT_MINIMUMSTOCK);
        assertThat(testStock.getMaximumstock()).isEqualTo(DEFAULT_MAXIMUMSTOCK);
        assertThat(testStock.getDetail()).isEqualTo(DEFAULT_DETAIL);
    }
    ...
    public void getAllStocks() throws Exception {
        ...
        restStockMockMvc.perform(get("/api/stocks?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].minimumstock").value(hasItem(DEFAULT_MINIMUMSTOCK.intValue())))
            .andExpect(jsonPath("$.[*].maximumstock").value(hasItem(DEFAULT_MAXIMUMSTOCK.intValue())))
    ...
    public void getStock() throws Exception {
        ...
        restStockMockMvc.perform(get("/api/stocks/{id}", stock.getId()))
            ...
            .andExpect(jsonPath("$.minimumstock").value(DEFAULT_MINIMUMSTOCK.intValue()))
            .andExpect(jsonPath("$.maximumstock").value(DEFAULT_MAXIMUMSTOCK.intValue()))
    ...
    public void updateStock() throws Exception {
        ...
        assertThat(testStock.getMinimumstock()).isEqualTo(UPDATED_MINIMUMSTOCK);
        assertThat(testStock.getMaximumstock()).isEqualTo(UPDATED_MAXIMUMSTOCK);
        assertThat(testStock.getDetail()).isEqualTo(UPDATED_DETAIL);
    }
